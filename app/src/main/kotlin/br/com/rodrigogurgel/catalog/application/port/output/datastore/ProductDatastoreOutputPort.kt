...
interface ProductDatastoreOutputPort {
    ...
    suspend fun exists(productId: Id): Result<Boolean, Throwable>
    ...
    suspend fun getIfNotExists(productIds: List<Id>): Result<List<Id>, Throwable>
    suspend fun getProducts(storeId: Id, limit: Int, offset: Int): Result<List<Product>, Throwable>
